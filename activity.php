                ...
                <div class="container px-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            ...
                            <li class="nav-item"><a class="nav-link" href="activity.php">Projects</a></li>
                            <li class="nav-item"><a class="nav-link" href="https://wa.me/6285852078017">Contact</a></li>
                            ...
                            <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center">
                                        <div class="p-5">
                                            <h2 class="fw-bolder"><?= $row["nama"]; ?></h2>
                                            <p><?= $row["descrip"]; ?></p>
                                        </div>
                                        <img src="img\<?= $row["gambar"] ?>" width=400" height="300">
            ...
            <section class="py-5 bg-gradient-primary-to-secondary text-white">
                <div class="container px-5 my-5">
                    <div class="text-center">
                        <h2 class="display-4 fw-bolder mb-4">This is a fun activity</h2>
                        <a class="btn btn-outline-light btn-lg px-5 py-3 fs-6 fw-bolder" href="https://wa.me/6285852078017">Contact me</a>
                    </div>
                </div>
            </section>
        </main>
