        ...
        <main class="flex-shrink-0">
            ...
            <div class="container px-5 my-5">
                <div class="text-center mb-5 p-5">
                    <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline">Resume, Taufik</span></h1>
                </div>
                                    ...
                                    <div class="row align-items-center gx-5">
                                        <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                            <div class="bg-light p-4 rounded-4">
                                                <div class="text-primary fw-bolder mb-2">2021 - Sekarang</div>
                                                <div class="small fw-bolder">Mahasiswa</div>
                                                <div class="small text-muted">Teknik Informatika</div>
                                                <div class="small text-muted">Kediri, Indonesia</div>
                                            </div>
                                        </div>
